$(document).ready(function() {
    ...
    var target_date = new Date("March 11, 2017").getTime();
    ...
    setInterval(function () {
        ...
        secs_span.innerHTML = '<span class="number">' + seconds + '</span>' + '<span class="unit script">Seg</span>';
    ...
    map.addMarker({
        lat: -27.489347,
        lng: -48.703462,
        title: 'Local Cerimônia',  
        infoWindow: {
            content: '<div class="note">Cerimônia</div><h4 class="map-title script">Estância Biguaçu</h4><div class="address"><span class="region">SC-407, KM6</span><br><span class="postal-code"></span><br><span class="city-name">Biguaçu</span></div>'
        }
    ...
    map.addMarker({
        ...
        infoWindow: {
            content: '<div class="note">Recepção</div><h4 class="map-title script">Estância Biguaçu</h4><div class="address"><span class="region">SC-407, KM6</span><br><span class="postal-code">Postcode</span><br><span class="city-name">Biguaçu</span></div>'
        } 
